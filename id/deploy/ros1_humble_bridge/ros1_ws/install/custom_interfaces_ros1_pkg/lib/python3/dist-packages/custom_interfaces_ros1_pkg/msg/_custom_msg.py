...
"""autogenerated by genpy from custom_interfaces_ros1_pkg/custom_msg.msg. Do not edit."""
import codecs
import sys
...
class custom_msg(genpy.Message):
  _md5sum = "b7495536a7da3b15db70b8303e04a2a6"
  _type = "custom_interfaces_ros1_pkg/custom_msg"
...
float64 w
"""
  __slots__ = ['header','child_frame_id','custom_bool','custom_int','custom_double','pose']
  _slot_types = ['std_msgs/Header','string','bool','int8','float64','geometry_msgs/PoseWithCovarianceStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,child_frame_id,custom_bool,custom_int,custom_double,pose
    ...
    if args or kwds:
      ...
      if self.child_frame_id is None:
        self.child_frame_id = ''
      if self.custom_bool is None:
        self.custom_bool = False
      if self.custom_int is None:
        self.custom_int = 0
      if self.custom_double is None:
        self.custom_double = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_Bbd3I().pack(_x.custom_bool, _x.custom_int, _x.custom_double, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.custom_bool, _x.custom_int, _x.custom_double, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_Bbd3I().unpack(str[start:end])
      self.custom_bool = bool(self.custom_bool)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_7d():
    ...
    return _struct_7d
_struct_Bbd3I = None
def _get_struct_Bbd3I():
    global _struct_Bbd3I
    if _struct_Bbd3I is None:
        _struct_Bbd3I = struct.Struct("<Bbd3I")
    return _struct_Bbd3I
