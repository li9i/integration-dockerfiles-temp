...
#ifndef CUSTOM_INTERFACES_ROS2_PKG__MSG__DETAIL__CUSTOM_MSG__STRUCT_HPP_
#define CUSTOM_INTERFACES_ROS2_PKG__MSG__DETAIL__CUSTOM_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__custom_interfaces_ros2_pkg__msg__CustomMsg __attribute__((deprecated))
#else
# define DEPRECATED__custom_interfaces_ros2_pkg__msg__CustomMsg __declspec(deprecated)
#endif
...
struct CustomMsg_
{
  ...
  // pointer types
  using RawPtr =
    custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__custom_interfaces_ros2_pkg__msg__CustomMsg
    std::shared_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__custom_interfaces_ros2_pkg__msg__CustomMsg
    std::shared_ptr<custom_interfaces_ros2_pkg::msg::CustomMsg_<ContainerAllocator> const>
...
using CustomMsg =
  custom_interfaces_ros2_pkg::msg::CustomMsg_<std::allocator<void>>;
...
#endif  // CUSTOM_INTERFACES_ROS2_PKG__MSG__DETAIL__CUSTOM_MSG__STRUCT_HPP_
