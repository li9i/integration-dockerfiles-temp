...
bool custom_interfaces_ros2_pkg__msg__custom_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces_ros2_pkg.msg._custom_msg.CustomMsg", full_classname_dest, 52) == 0);
  }
  custom_interfaces_ros2_pkg__msg__CustomMsg * ros_message = _ros_message;
  {  // header
...
PyObject * custom_interfaces_ros2_pkg__msg__custom_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces_ros2_pkg.msg._custom_msg");
