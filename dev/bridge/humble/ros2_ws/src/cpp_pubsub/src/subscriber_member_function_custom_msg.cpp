...
#include "custom_interfaces_ros2_pkg/msg/custom_msg.hpp"
...
class MinimalSubscriber : public rclcpp::Node
{
    ...
    MinimalSubscriber() : Node("minimal_subscriber")
  {
    ...
    custom_subscription_ = this->create_subscription<custom_interfaces_ros2_pkg::msg::CustomMsg>(
  ...
  private:
    ...
    //--------------------------------------------------------------------------
    // https://answers.ros.org/question/400785/problem-with-subscriber-ros2/
    void topic_custom_callback(const custom_interfaces_ros2_pkg::msg::CustomMsg::SharedPtr msg) const
    {
    ...
    rclcpp::Subscription<custom_interfaces_ros2_pkg::msg::CustomMsg>::SharedPtr custom_subscription_;
